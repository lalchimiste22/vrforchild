...
namespace Nvr.Internal
{
    ...
    [CustomEditor(typeof(NvrStereoController))]
    public class NVRStereoControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //{
            //    var controller = (NvrStereoController)target;
        ...
        [MenuItem("Component/NVR/Update Stereo Cameras", true, 40)]
        ...
        [MenuItem("Component/NVR/Update Stereo Cameras", false, 42)]
        ...
        private static bool CanUpdateStereoCameras(GameObject go)
        {
            return go != null &&
                   ...
                   go.GetComponent<NvrEye>() == null;
        }

        private static void DoUpdateStereoCameras(GameObject go)
        {
            // Make sure there is a StereoController.
            var controller = go.GetComponent<NvrStereoController>();
            if (controller == null)
            {
                controller = go.AddComponent<NvrStereoController>();
            ...
            // Head.
            var head = go.GetComponent<NvrHead>();
